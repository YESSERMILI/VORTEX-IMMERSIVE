          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div className="space-y-12">
              <div className="space-y-6">
                ...
                <h1 className="text-6xl md:text-8xl font-black font-headline tracking-tighter leading-[0.85]">
                  EXPERIENCE <br />
              ...
              <div className="space-y-8 pt-8">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="font-bold uppercase tracking-tight mb-2">Technical Deep Dive</h3>
                    <p className="text-sm text-muted-foreground">Explore the software stack behind our stadium-scale projections.</p>
                  </div>
                </div>
                <div className="flex items-start gap-6">
                  <div className="w-12 h-12 flex-shrink-0 flex items-center justify-center border border-border">
                  ...
                  <div>
                    <h3 className="font-bold uppercase tracking-tight mb-2">Interactive Preview</h3>
                    <p className="text-sm text-muted-foreground">See how AI and motion tracking integrate into live environments.</p>
                  </div>
                </div>
                <div className="flex items-start gap-6">
                  <div className="w-12 h-12 flex-shrink-0 flex items-center justify-center border border-border">
                  ...
                  <div>
                    <h3 className="font-bold uppercase tracking-tight mb-2">Custom Q&A</h3>
                    <p className="text-sm text-muted-foreground">Discuss your specific project requirements with our directors.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input id="name" required placeholder="Full Name" className="rounded-none bg-background border-border h-12" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="company" className="text-[10px] uppercase tracking-widest text-muted-foreground">Company</Label>
                    <Input id="company" required placeholder="Organization" className="rounded-none bg-background border-border h-12" />
                  </div>
                </div>

                <div className="space-y-2">
                  <Label htmlFor="email" className="text-[10px] uppercase tracking-widest text-muted-foreground">Email</Label>
                  <Input id="email" type="email" required placeholder="your@email.com" className="rounded-none bg-background border-border h-12" />
                </div>

                <div className="space-y-2">
                  <Label className="text-[10px] uppercase tracking-widest text-muted-foreground">Preferred Date</Label>
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button
                        variant={"outline"}
                        className={cn(
                          "w-full justify-start text-left font-normal h-12 rounded-none border-border bg-background",
                ...
                <div className="space-y-2">
                  <Label htmlFor="message" className="text-[10px] uppercase tracking-widest text-muted-foreground">Special Requests</Label>
                  <Textarea id="message" placeholder="Any specific topics or technology you'd like to see?" className="rounded-none bg-background border-border min-h-[120px] resize-none" />
                </div>

                <Button type="submit" disabled={loading} className="w-full h-14 rounded-none group text-sm font-bold uppercase tracking-widest">
                  {loading ? (
