...
const WORKS = [
  { id: 1, title: "World Cup Opening Ceremony", category: "ceremony", year: "2022", client: "FIFA", desc: "A breathtaking spectacle that combined projection mapping, kinetic sculptures, and live performance to celebrate global unity.", scale: "Stadium", imageId: 'work-1' },
  { id: 2, title: "Electric Symphony World Tour", category: "concert", year: "2023", client: "Universal Music", desc: "360-degree immersive visuals for a world-renowned DJ, featuring real-time reactive content synchronized with audio frequencies.", scale: "Arena Tour", imageId: 'work-2' },
  { id: 3, title: "Future Tech Summit", category: "brand", year: "2024", client: "TechCorp", desc: "Product launch transformed into a futuristic journey using holographic displays and interactive floor projections.", scale: "Convention Center", imageId: 'work-3' },
  { id: 4, title: "Digital Ocean Pavilion", category: "installation", year: "2023", client: "Expo 2023", desc: "An interactive museum installation where visitors navigate through a responsive digital ocean using gesture controls.", scale: "Museum", imageId: 'work-4' },
  { id: 5, title: "Aurora Borealis Experience", category: "installation", year: "2022", client: "Art Foundation", desc: "Permanent light installation recreating the northern lights using advanced LED arrays and atmospheric effects.", scale: "Gallery", imageId: 'work-5' },
  { id: 6, title: "Global Brand Summit", category: "brand", year: "2024", client: "Fortune 500", desc: "Executive conference featuring architectural projection mapping that transformed the venue throughout the event.", scale: "Hotel", imageId: 'work-6' }
];
              ...
              <Dialog key={work.id}>
                ...
                <DialogContent className="max-w-4xl p-0 border-border bg-card rounded-none gap-0">
                  <div className="relative aspect-video w-full bg-black">
                    <Image
                      src={imageData?.imageUrl || 'https://placehold.co/1200x675'}
                      alt={work.title}
                      fill
